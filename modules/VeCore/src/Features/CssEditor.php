...
class VeCore_CssEditor extends Ve_Feature_Abstract{
    ...
    function form($instance) {
        ...
        $output .= '<div class="ve_col-xs-5 ve_settings">'
            ...
            .'<h5><input type="radio" name="adv-bg-type" checked="checked" value="image" /> Image &nbsp;&nbsp; <input type="radio" name="adv-bg-type" value="color" /> Solid color </h5>'

            . '    <div class="background-settings">'
            . '       <div class="adv-bg adv-img-bg">'
            . '         <div class="ve_background-style"><span class="label">Style: </span><select name="background_style" class="ve_background-style">' . $this->getBackgroundStyleOptions() . '</select></div>'
            ...
            . '       </div>'
            . '       <div class="adv-bg adv-solid-bg">'
            . '         <div class="color-group"><span class="label">Color: </span><input type="text" name="background_color" value="'.$this->get_field_value('background_color').'" class="ve_color-control"></div>'
            . '       </div>'
            . '    </div>'
            . '</div>';
        $output .= '';
